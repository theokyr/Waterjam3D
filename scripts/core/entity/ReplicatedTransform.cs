...
{
    [Export]
    public float UpdateRate { get; set; } = 20.0f; // Updates per second

    [Export]
    public float PositionThreshold { get; set; } = 0.01f; // Min distance to trigger update

    [Export]
    public float RotationThreshold { get; set; } = 0.01f; // Min rotation change (radians)
